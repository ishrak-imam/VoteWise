...
function useWebViewOnMessage(
  ...
  const webViewOnMessage = React.useCallback(
    (event: WebViewMessageEvent) => {
      ...
      const {message, id} = JSON.parse(event.nativeEvent.data) as {
        message: Message;
        id: string;
      };
      ...
      switch (message.type) {
        ...
        case MessageType.UPDATE_ACCOUNT_META_RESULT: {
          ...
          if (account) {
            const updatedAccount = {
              ...account,
              meta: {...account.meta, ...message.payload.meta},
            };
            setAccounts(_accounts => ({
              ..._accounts,
        ...
        case MessageType.GET_TX_PAYLOAD_RESULT: {
          ...
          if (payload.error) {
            ...
            getTxPayloadPromise.resolve[id]?.({
              txPayload: payload.txPayload,
              signablePayload: payload.signablePayload,
            });
          }
